...
export default function Slots() {
  ...
  return (
    <>
            ...
            <div style={{ position: 'relative', paddingTop: 'env(safe-area-inset-top, 0px)' }}>
              ...
              <img
                ...
                style={{
                  ...
                  marginTop: '-30px',
                  marginBottom: '-70px',         // ← Tiefer, aber nicht abgeschnitten
                  boxShadow: '0 12px 30px rgba(0,0,0,0.6)',
                  zIndex: 1,
                }}
              />

              {/* Payout-Box – RESPONSIVE POSITION */}
              <div
      ...
      {/* STYLING – MOBILE 75%/25%, DESKTOP NORMAL, SPIN NICHT ZU KLEIN */}
      <style jsx>{`
        .slots-container {
          display: flex;
        ...
        /* MOBILE: 75%/25% – NUR MOBILE, SPIN GRÖßER */
        @media (max-width: 768px) {
          ...
          .wager-spin-row .spin-btn-inline {
            ...
            font-size: 1rem !important;     // ← Größer als vorher
